...
function Pin() {
  ...
  return (
    <div style={{ height: "200vh", width: "100%" }}>
      <ReactMapGL
        {...viewport}
        mapboxApiAccessToken="pk.eyJ1IjoibWluZ28tbWluZ28iLCJhIjoiY2x3Nmh4OHR3MWxrYzJpbDh5ZHpud2VrZiJ9.XKNFKc6eDqPubFZ2gfwWxA"
        width="100%"
        height="100%"
            ...
            {p._id === currentPlaceId && (
              ...
              >
                <div className="carddd" key="index">
                  ...
                  <label className="label">Revoir</label>
                  <p className="desccc">{p.desc}</p>
                  <label className="label">Notation</label>
                  <div className="starss">
                    {Array(p.rating).fill(<Star className="starr" />)}
                  </div>
                  <label>Information</label>
                  <span className="usernamee">
                    Créé par <b>{p.username.username}</b>
                  </span>
